...
public class GetByNamesTests
{
    [Fact]
    public async Task GetByNames_ShouldReturnCollabIds_WhenUsersAndCollabsExist()
    {
        // arrange
        ...
        userRepoDouble.Setup(r => r.GetByNamesAsync(It.IsAny<string>())).ReturnsAsync(new List<IUser> { userDouble.Object });
        ...
        // act
        var result = await service.GetByNames("Ana");
