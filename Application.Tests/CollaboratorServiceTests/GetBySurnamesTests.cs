...
public class GetBySurnamesTests
{
    [Fact]
    public async Task GetBySurnames_ShouldReturnCollabIds_WhenUsersAndCollabsExist()
    {
        // arrange
        ...
        userRepoDouble.Setup(r => r.GetBySurnamesAsync(It.IsAny<string>())).ReturnsAsync(new List<IUser> { userDouble.Object });
        ...
        // act
        var result = await service.GetBySurnames("Silva");
